...
thumbnail: /images/post/react-basic/thumbnail.png
---
...
![0](/images/post/react-basic/0.png)
...
![1](/images/post/react-basic/1.png)

### 폴더 shift + 우클릭, powershell 열기
    
![2](/images/post/react-basic/2.png)
...
프로젝트명은 원하는거 작성하면 된다.
필자는 blog 로 작명했다.
![3](/images/post/react-basic/3.png)

### VSC에서 폴더 열기
    
![4](/images/post/react-basic/4.png)

### src폴더 안에 있는 App.js가 메인화면이다.
프로젝트 잘 뜨는지 확인하기
    
![5](/images/post/react-basic/5.png)
- node_modules 폴더는 라이브러리 코드 보관함
- public 폴더는 static 파일 모아놓는 폴더(이미지 같은거)
- src 폴더는 코드 짜는 폴더
### 터미널 설정하기
    
![6](/images/post/react-basic/6.png)
Terminal 탭에서 New Terminal 열기
    
![7](/images/post/react-basic/7.png)
```jsx
  npm start
```

...
## 2024년 1월 08일
1. darkmode 완성
   - https://www.toptal.com/designers/ui/dark-ui-design 참조하여 다크모드 구현중 주의사항 조사
   - 순수 검은색(#000000)이 아닌 구글의 추천 색상인 다크 그레이(#121212)사용
   - 다크모드에서는 채도가 낮은 색상을 사용해야하므로 블로그 메인컬러의 채도를 낮춤
